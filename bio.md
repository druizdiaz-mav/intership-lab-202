...
Vivo en **Pueblo Esther**, un pueblito a 17 km de Rosario.
...
Soy Luca Olvieri, tengo 22 años, nací el 13 de noviembre de 2003 y soy Estudiante 
de Ingeniería en Sistemas de Información. Actualmente me encuentro finalizando mi tercer año en 
la facultad a la par que trabajo en una pasantía en la empresa Renaiss. También me encuentro 
trabajando en un proyecto para la materia desarrollo de software para la facultad junto con 4 compañeros, 
en el que utilizamos typescript con react y vite para frontend, y typescript con nodejs y mikroORM para backend. 
En este proyecto de desarrollo de software tengo pendiente implementar test automatizados, captcha y un chatbot.
...
- Iris: Emulador de PlayStation 2
  Tecnologias: C, C++, ImGui, Vulkan, SDL3
- koalaos: Sistema operativo para MIPS I
  Tecnologias: C, Assembly
- koala: Lenguaje de programación interpretado
  Tecnologias: C++
